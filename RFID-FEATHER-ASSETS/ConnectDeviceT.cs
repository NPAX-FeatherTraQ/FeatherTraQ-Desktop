...
{
    public partial class ConnectDeviceT : Form
    {
        Tracking contextForm = null;
        //string connectionType;
        //string connectionParam;
        //string connectionParam2;

        public ConnectDeviceT()
        {
            InitializeComponent();
        ...
        public ConnectDeviceT(Tracking contextForm)
            : this()
        {
        ...
        public ConnectDeviceT(Tracking contextForm, Int32 connType): this(contextForm)
        {
            InitCom();
            if (connType == 0)
            {
        ...
        private void cb_ConnectType_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cb_ConnectType.SelectedIndex == 0)
            {
                ////tb_ConnParam.Text = Helper.MyXmlHelper.ReadInnerText(XMLFIENAME, "Root/ConnectDeviceT", "SerialConnect");
            ...
            {
                ////tb_ConnParam.Text = Helper.MyXmlHelper.ReadInnerText(XMLFIENAME, "Root/ConnectDeviceT", "TcpConnect");
                //if (String.IsNullOrEmpty(tb_ConnParam.Text.Trim()))
                //{
            ...
            {
                ////tb_ConnParam.Text = Helper.MyXmlHelper.ReadInnerText(XMLFIENAME, "Root/ConnectDeviceT", "_485Connect");
                //if (String.IsNullOrEmpty(tb_ConnParam.Text.Trim()))
                //{
