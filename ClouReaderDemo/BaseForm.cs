...
namespace ClouReaderDemo
{
    public partial class BaseForm : Form
    {
        ...
        {
            return MessageBox.Show(msg, "Tip", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
        }
        /// <summary>
        /// 获得16进制字符串(Byte)
        /// </summary>
        ...
        {
            String rt = "";
            rt = ClouReaderAPI.MyHelper.MyString.ByteToString(iParam);
            return rt;
        }
        /// <summary>
        /// 获得16进制字符串(Uint16)
        ...
        {
            String rt = "";
            rt = ClouReaderAPI.MyHelper.MyString.ByteToString(GetReverseU16(iParam));
            return rt;
        }
        /// <summary>
        /// 获得16进制字符串(Uint32)
        ...
        {
            String rt = "";
            rt = ClouReaderAPI.MyHelper.MyString.ByteToString(GetReverseU32(iParam));
            return rt;
        }
        /// <summary>
        /// 获得网络字节序的U16
